...
- docs/reviews/tech-stack/antigravity-review.json (depth 4+, if available) — raw Antigravity recommendations
...
- **deep**: Comprehensive research with competitive analysis for each category.
  ...
  research dispatched to Codex and Antigravity if available, with graceful fallback
