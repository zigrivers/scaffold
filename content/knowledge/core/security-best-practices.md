...
The OWASP Top 10 represents the most critical security risks to web applications. Every project should evaluate each risk and implement appropriate mitigations. The current edition is the OWASP Top 10:2025, which reorganizes and updates the previous 2021 categories.
...
> **Note:** The OWASP Top 10:2025 edition has reorganized categories. The above list reflects the 2021 categories that the entry was originally based on. A full update to the 2025 taxonomy (which may include new or reordered categories) should be performed once the 2025 edition content is available for review.
