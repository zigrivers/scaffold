...
| CLI not installed | Check the project's documented install path and available local CLI; install only within applicable dependency/install policy. Otherwise report the missing tool and command. |
