...
export const cliCopy: CliCopy = {
  interactivity: {
    ...
    options: {
      ...
      'hybrid':       { label: 'Hybrid',       short: 'Interactive when run by a human, flags-only when piped or scripted.' },
    },
  },
  distributionChannels: {
    ...
    options: {
      'package-manager':        { label: 'Package manager (npm/yarn/pnpm)', short: 'Published to a JS registry and installed via npm or similar.' },
      'system-package-manager': { label: 'System package manager (Homebrew/apt)', short: 'Distributed through OS-level package managers.' },
      'standalone-binary':      { label: 'Standalone binary',                short: 'Single executable with no runtime dependencies.' },
      'container':              { label: 'Container (Docker)',               short: 'Packaged as a Docker image for isolated execution.' },
    },
  },
  hasStructuredOutput: {
