...
const CALIBRATION: Record<Stage, string> = {
  prototype: [
    ...
    '  to demonstrate. A bug on a path nobody exercises yet is P3, not P1.',
  ...
  mvp: [
    ...
    '',
    '- Grade correctness findings on what a current user can hit. A bug in a flow',
    '  users reach is P1; one behind a path they cannot reach yet is P3.',
  ...
  production: [
    ...
    '',
    '- Grade correctness findings on impact if reached at all, not on how often.',
    '  A rare but reachable failure in a user-facing path is P1.',
