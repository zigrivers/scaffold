...
| Step | Description | Conditional |
|------|-------------|-------------|
| `domain-modeling` | Deep domain modeling — entities, aggregates, bounded contexts, domain events, invariants | No |
| `review-domain-modeling` | Review domain models for completeness, consistency, downstream readiness | No |
...
---
Execute: scaffold run system-architecture
```
...
```markdown
## System Architecture
Run `scaffold run system-architecture` to design system architecture.
```
...
<!-- scaffold:managed by system-architecture -->

## Key Commands
<!-- scaffold:managed by operations -->
...
## Testing
<!-- scaffold:managed by testing-strategy -->
```
