...
- `docs/adrs/` (primary artifact), `docs/domain-models/`, `docs/system-architecture.md`, `docs/plan.md`
- Focus areas: implied-but-unrecorded decisions, contradictions between ADRs, stale "Proposed" status
...
10. (Depth 4+) Dispatch multi-model validation — verify CLI auth, bundle context, dispatch, reconcile findings, apply high-confidence fixes
11. Execute approved fixes
